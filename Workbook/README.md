...
The macro-enabled Excel workbook (`IDP_Workbook_CurrentWIP_3.xlsm`) that engineers fill out to describe conduits and wire fills, which LISA's IDP Generation service reads to generate AutoCAD electrical IDP drawings.

## Contents

- **`IDP_Workbook_CurrentWIP_3.xlsm`** — the actual workbook (binary, macro-enabled).
