...
FILL_CONVENTIONS = [
    ...
    ("Control panel is a landing, not a motor", "A named CONTROL PANEL / CABINET / "
     "PCP / LCP / MCP is a terminal-block landing (`TB_Square`), even when the name "
     "contains PUMP (e.g. `PUMP CONTROL PANEL`). Only a real motor/pump LOAD "
     "(`WELL PUMP P-01`, `MTR`, `PMP-`) is `MTR_3PH`. Enforced in `symbol_infer` "
     "ahead of the motor rule."),
